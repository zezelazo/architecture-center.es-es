...
## <a name="ai-scenarios"></a>Escenarios de inteligencia artificial
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Bot conversacional para reservas de hotel en Azure</h3>
                        <p>Cree un bot conversacional para aplicaciones de comercio con Azure Bot Service.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Clasificación de imágenes de reclamaciones de seguros en Azure</h3>
                        <p>Compile el procesamiento de imágenes en sus aplicaciones de Azure.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Migración de una aplicación web heredada a una arquitectura basada en API en Azure</h3>
                        <p>Use Azure API Management para modernizar una aplicación web heredada.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Confianza descentralizada entre bancos en Azure</h3>
                        <p>Establezca un entorno de confianza para la comunicación y el uso compartido de información sin tener que recurrir a una base de datos centralizada.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Canalización de CI/CD para cargas de trabajo basadas en contenedores</h3>
                        <p>Cree una canalización de DevOps para una aplicación web de Node.js con Jenkins, Azure Container Registry, Azure Kubernetes Service, Cosmos DB y Grafana.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Front-end de comercio electrónico en Azure</h3>
                        <p>Hospede un sitio de comercio electrónico en Azure.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Motor de búsqueda inteligente de productos para comercio electrónico</h3>
                        <p>Proporcione una experiencia de búsqueda de alcance mundial en una aplicación de comercio electrónico.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Un servicio de ingeniería asistida por PC en Azure</h3>
                        <p>Proporcione una plataforma de software como servicio (SaaS) de ingeniería asistida por PC (CAE) en Azure.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Entornos de desarrollo y pruebas para cargas de trabajo SAP en Azure</h3>
                        <p>Cree un entorno de desarrollo y pruebas para las cargas de trabajo SAP.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Ejecución de cargas de trabajo SAP de producción mediante una base de datos de Oracle en Azure</h3>
                        <p>Ejecute una implementación de producción de SAP en Azure mediante una base de datos de Oracle.</p>
                    </div>
                </div>
            </div>
        </div>
...
## <a name="data-scenarios"></a>Escenarios de datos
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>IoT y el análisis de datos en el sector de la construcción</h3>
                        <p>Use dispositivos de IoT y análisis de datos para proporcionar una administración y un funcionamiento integral de proyectos de construcción.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Almacenamiento de datos y análisis de ventas y marketing</h3>
                        <p>Consolide datos de varios orígenes y optimice el análisis de datos.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Procesamiento de pedidos escalable en Azure</h3>
                        <p>Cree una canalización de procesamiento de pedidos altamente escalable con Azure Cosmos DB.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Detección de fraudes en tiempo real en Azure</h3>
                        <p>Detecte actividades fraudulentas en tiempo real con Azure Event Hubs y Stream Analytics.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Extracción, transformación y carga de datos híbrida con instancias locales ya existentes de SQL Server Integration Services y Azure Data Factory</h3>
                        <p>Extracción, transformación y carga de datos híbrida con implementaciones locales ya existentes de SQL Server Integration Services (SSIS) y Azure Data Factory</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Ingesta y procesamiento de datos de IoT de automoción en tiempo real</h3>
                        <p>Ingiera y procese datos del vehículo en tiempo real con IoT.</p>
                    </div>
                </div>
            </div>
        </div>
...
## <a name="infrastructure-scenarios"></a>Escenarios de infraestructura
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Simulaciones de dinámicas de fluido computacionales (CFD) en Azure</h3>
                        <p>Ejecute simulaciones de dinámicas de fluido computacionales (CFD) en Azure.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Escritorios virtuales Linux con Citrix</h3>
                        <p>Cree un entorno VDI para escritorios de Linux mediante Citrix en Azure.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Aplicación web de varios niveles creada para lograr alta disponibilidad y recuperación ante desastres en Azure</h3>
                        <p>Cree una aplicación web de varios niveles para lograr una alta disponibilidad y recuperación ante desastres en Azure mediante máquinas virtuales, conjuntos de disponibilidad y zonas de disponibilidad de Azure, Azure Site Recovery y Azure Traffic Manager</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Uso de Service Fabric para descomponer aplicaciones monolíticas</h3>
                        <p>Descomponga una gran aplicación monolítica en microservicios.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Representación de vídeo en 3D en Azure</h3>
                        <p>Ejecute cargas de trabajo de HPC nativas en Azure mediante el servicio Azure Batch.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Sitios web altamente escalables y seguros de WordPress en Azure</h3>
                        <p>Cree un sitio web de WordPress altamente escalable y seguro para eventos multimedia.</p>
                    </div>
                </div>
            </div>
        </div>
