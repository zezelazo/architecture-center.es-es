...
---
# <a name="content-delivery-networks-cdns"></a>Redes de entrega de contenido
...
En este tema se describen algunos procedimientos recomendados y consideraciones generales cuando se usa una red CDN. Para más información, consulte [Azure CDN](/azure/cdn/).
