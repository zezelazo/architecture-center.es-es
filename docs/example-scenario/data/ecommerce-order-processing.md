...
- *[Designing Data-Intensive Applications](https://dataintensive.net)* (Diseño de aplicaciones de uso intensivo de datos) por Martin Kleppmann (O'Reilly Media, 2017).
