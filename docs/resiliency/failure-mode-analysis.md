...
**Detección**. Detecte la excepción. Para clientes. NET, suele ser `System.Web.HttpException`. Otros clientes pueden tener otros tipos de excepción.  Para más información, consulte [Cassandra error handling done right](https://www.datastax.com/dev/blog/cassandra-error-handling-done-right) (Correcto control de errores en Cassandra).
