...
---
# <a name="implement-a-dmz-between-azure-and-your-on-premises-datacenter"></a>Implementación de una zona DMZ entre Azure y el centro de datos local
...
Use el [control de acceso basado en rol][rbac] (RBAC) para administrar los recursos de la aplicación. Considere la posibilidad de crear los siguientes [roles personalizados][rbac-custom-roles]:
