...
- **CDN**. Azure CDN admite HTTPS en el subdominio `*.azureedge.net` de manera predeterminada. Para habilitar HTTPS en la red CDN para los nombres de dominio personalizado, consulte [Tutorial: Configuración de HTTPS en un dominio personalizado de Azure CDN][cdn-https].
