...
---
# <a name="run-a-web-application-in-multiple-azure-regions-for-high-availability"></a>Ejecución de una aplicación web en varias regiones de Azure para alta disponibilidad
...
## <a name="availability-considerations---traffic-manager"></a>Consideraciones sobre disponibilidad: Traffic Manager
...
## <a name="availability-considerations---sql-database"></a>Consideraciones sobre disponibilidad: SQL Database
...
## <a name="availability-considerations---storage"></a>Consideraciones sobre disponibilidad: almacenamiento
...
## <a name="manageability-considerations---traffic-manager"></a>Consideraciones sobre facilidad de uso: Traffic Manager
...
## <a name="manageability-considerations---sql-database"></a>Consideraciones sobre facilidad de uso: SQL Database
