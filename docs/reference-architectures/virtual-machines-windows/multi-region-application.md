...
Esta arquitectura se basa en la que se muestra en [Run Windows VMs for an N-tier application](n-tier.md) (Ejecución de máquinas virtuales Windows para una aplicación de N niveles). 
...
Para más información, consulte [Running Windows VMs for an N-tier architecture on Azure](n-tier.md) (Ejecución de máquinas virtuales Windows para una arquitectura de N niveles en Azure).
