...
- Clase de tipo II: S384, S384m, S384xm, S576m, S768m y S960m
...
- Nota de SAP [2121330][sap-2121330] FAQ: SAP BW on HANA Sizing Report (Preguntas más frecuentes: informe de ajuste de tamaño de SAP BW en HANA)
...
- Los datos en tránsito entre HANA (instancias grandes) y las máquinas virtuales no se cifran. Para cifrar la transferencia de datos, habilite el cifrado específico de la aplicación. Consulte la Nota de SAP [2159014][sap-2159014] FAQ: SAP HANA Security (Preguntas más frecuentas: seguridad de SAP HANA).
