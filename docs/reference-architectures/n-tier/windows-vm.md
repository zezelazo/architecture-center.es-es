...
ms.locfileid: "45584704"
---
# <a name="run-a-windows-vm-on-azure"></a>Ejecución de una VM con Windows en Azure

En este artículo se muestra un conjunto de prácticas demostradas para ejecutar una máquina virtual Windows en Azure. Incluye recomendaciones para el aprovisionamiento de la máquina virtual junto con los componentes de red y almacenamiento. [**Implemente esta solución.**](#deploy-the-solution)
