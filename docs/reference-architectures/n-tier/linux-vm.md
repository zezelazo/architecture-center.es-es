...
En este artículo se muestra un conjunto de prácticas demostradas para ejecutar una máquina virtual Linux en Azure. Incluye recomendaciones para el aprovisionamiento de la máquina virtual junto con los componentes de red y almacenamiento. [**Implemente esta solución.**](#deploy-the-solution)
