...
Contoso necesita compilar una aplicación de línea de negocio y una aplicación orientada al cliente. Ha decidido ejecutar las aplicaciones en Azure. David lee el tema sobre [gobierno de suscripción preceptivo](subscription-governance.md) y ahora está listo para implementar las recomendaciones.
