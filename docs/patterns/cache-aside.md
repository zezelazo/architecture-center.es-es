...
El método `GetMyEntityAsync` del código de ejemplo siguiente muestra una implementación del patrón Cache-Aside. Este método recupera un objeto de la caché mediante el enfoque de lectura simultánea.
